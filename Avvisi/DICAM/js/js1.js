...
$(document).ready(function() {
  //$('ul.aw-download .parent').click(function() {
   //$(this).removeClass('closed').addClass('open');
  // $('ul',this).slideDown('slow');

  //});
  
//$('ul.aw-download .parent ul li ul').hide();
$('ul.aw-download .parent span').click(function() {
var azione = $(this);
var padre = $(this).parent();
if (padre.hasClass("closed")) {
//$($(this).siblings('ul').children()).slideDown('3000');
//padre.children().show();
//$('li',azione.next()).show();
azione.next().fadeIn('medium', function() {
padre.removeClass("closed");
});
//;
//alert('era chiuso');
} else {
azione.next().slideUp('medium', function() {
padre.addClass("closed");
});

//alert('ora lo chiudo');
}
//var ogg = $(this).parent();
//if (ogg.hasClass("closed")) {
//console.log($('ul:first',ogg));
//$('ul:first',ogg).show(function() {
//ogg.removeClass("closed");
//});
//} else {
//$('ul',ogg).hide(function() {
//ogg.addClass("closed");
//});
//}
})
