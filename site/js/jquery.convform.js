...
ConvState.prototype.answerWith = function(answerText, answerObject) {
    ...
    var message = $('<div class="message from" id="'+this.current.input.name+'" value="'+answerText+'">'+answerText+'</div>');
...
(function($){
    $.fn.convform = function(placeholder){
        ...
        */
        ...
        $(wrapper).append('<div class="wrapper-messages" id="wrapper-messages"><div id="messages"></div></div>');
